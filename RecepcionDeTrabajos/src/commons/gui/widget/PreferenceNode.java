...
/**
 * A concrete implementation of a node in a preference dialog tree. This class also supports lazy
 * creation of the node's preference page.
 */
public class PreferenceNode implements IPreferenceNode {
	...
	/**
	 * Creates a preference node with the given nodeId, label, and image, and lazily-loaded
	 * preference page. The preference node assumes (sole) responsibility for disposing of the
	 ...
	 * @param image
	 *            the image displayed left of the label in the preference dialog's tree, or
	 *            <code>null</code> if none
	 * @param className
	 *            the class name of the preference page; this class must implement
	...
	/**
	 * Creates a preference node with the given nodeId and preference page. The title of the
	 * preference page is used for the node label. The node will not have an image.
	 * 
	 * @param nodeId
	 *            the node nodeId
	...
	/**
	 * Text label for this node. Note that this field is only used prior to the creation of the
	 * preference page.
	 */
